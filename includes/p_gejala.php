...
$no=0;
$q=mysql_query("select * from daftar_gejala");

?>
<h3 class="p2">Data Gejala</h3>
<div style="clear:both;height:20px;"></div>
<a href="<?php echo $link_update;?>" class="btn blue" style="float:right">Tambah Data Gejala</a><br /><br />
<table class="table table-striped table-hover table-bordered" width="100%">
	<thead>
		<tr>
			...
			<th style="text-align:center; vertical-align:middle" rowspan="2">NAMA GEJALA</th>
